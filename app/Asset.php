...
class Asset extends Model
{
	...
	{
		$this->attributes['purchase_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
	...
	{
		$this->attributes['warranty_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
