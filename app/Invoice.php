...
class Invoice extends Model
{
	...
	{
		$this->attributes['invoice_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
	...
	{
		$this->attributes['invoice_due_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
