...
class SalaryBasicController extends Controller
{
    ...
    public function store(Request $request, Employee $employee)
    {
		...
		{
            $validator = Validator::make($request->only('month_year', 'payslip_type','basic_salary','overtime_rate'),[
                'month_year' => 'required',
            ...
            $salary_basic->overtime_rate = $request->overtime_rate;
            $salary_basic->save();
            ...
            $employee->overtime_rate = $salary_latest->overtime_rate; //Alawys Updated Last Month-Year wise
            $employee->update();
