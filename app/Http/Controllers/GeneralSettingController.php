...
class GeneralSettingController extends Controller {
	...
	public function update(Request $request, $id)
	{
		...
		if (auth()->user()->can('store-general-setting'))
		{
			...
			$searchArray = array('APP_TIMEZONE=' . config('app.APP_TIMEZONE'),'Date_Format=' . config('app.Date_Format'),'Date_Format_JS=' . config('app.Date_Format_JS'));
            ...
            $path = '.env';
            $searchArray = array('RTL_LAYOUT'.'='.config('app.RTL_LAYOUT'));
	...
	public function mailSettingStore(Request $request)
	{
		...
		if (auth()->user()->can('view-mail-setting'))
		{
			...
			$path = '.env';
			$searchArray = array('MAIL_HOST="' . config('app.MAIL_HOST') . '"', 'MAIL_PORT=' . config('app.MAIL_PORT'), 'MAIL_FROM_ADDRESS="' . config('app.MAIL_FROM_ADDRESS') . '"', 'MAIL_FROM_NAME="' . config('app.MAIL_FROM_NAME') . '"', 'MAIL_USERNAME="' . config('app.MAIL_USERNAME') . '"', 'MAIL_PASSWORD="' . config('app.MAIL_PASSWORD') . '"', 'MAIL_ENCRYPTION="' . config('app.MAIL_ENCRYPTION') . '"');
			// $searchArray = array('MAIL_HOST=' . config('app.MAIL_HOST'),'MAIL_PORT=' . config('app.MAIL_PORT'),'MAIL_FROM_ADDRESS=' . config('app.MAIL_FROM_ADDRESS'),'MAIL_FROM_NAME=' . config('app.MAIL_FROM_NAME'),'MAIL_USERNAME=' . config('app.MAIL_USERNAME'),'MAIL_PASSWORD=' . config('app.MAIL_PASSWORD'),'MAIL_ENCRYPTION=' . config('app.MAIL_ENCRYPTION'));
	...
	public function emptyDatabase()
	{
		...
		$str = 'Tables_in_' . config('app.DB_DATABASE');
	...
	public function exportDatabase()
	{
		...
		$database_name = config('app.DB_DATABASE');
