...
class Termination extends Model
{
	...
	{
		$this->attributes['termination_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
	...
	{
		$this->attributes['notice_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
