...
class FinanceTransaction extends Model
{
	...
	{
		$this->attributes['expense_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
	...
	{
		$this->attributes['deposit_date'] = Carbon::createFromFormat(config('app.Date_Format'), $value)->format('Y-m-d');
	}
