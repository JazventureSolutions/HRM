...
Route::group(['middleware' => ['XSS']], function ()
{
	...
	Route::prefix('organization')->group(function ()
	{
...

		{
			...
			Route::resource('policy', 'PolicyController')->except(['destroy', 'create', 'update']);
		...
		{
			Route::post('late_policy/update', 'LatePolicyController@update')->name('late_policy.update');
			Route::resource('late_policy', 'LatePolicyController')->except(['destroy', 'create', 'update']);
			Route::get('late_policy/{id}/delete', 'LatePolicyController@destroy')->name('late_policy.destroy');
			Route::post('late_policy/delete/selected', 'LatePolicyController@delete_by_selection')->name('mass_delete_policy');
		}
	...
	Route::prefix('timesheet')->group(function ()
	{
		...
		Route::post('attendances/page/import', 'AttendanceController@importAttendance')->name('attendances.importAttendance');

		Route::post('attendance/employee/{id}', 'AttendanceController@employeeAttendance')->name('employee_attendance.post');
		
		Route::post('attendance_update/update', 'AttendanceController@attendanceUpdate')->name('attendance.update');
