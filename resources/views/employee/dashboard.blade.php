                                        ...
                                        <div class="tab-pane fade show active" id="Basic" role="tabpanel"
                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('NIC No')}}</label>
                                                        <input type="text" name="nic_no" id="nic_no"
                                                               placeholder="{{__('NIC No')}}"
                                                                class="form-control"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="status_id_hidden" value="{{ $employee->status_id }}"/>
                                                            <select name="status_id" id="status_id" class="form-control selectpicker" data-live-search="true" data-live-search-style="contains" title="{{__('Selecting',['key'=>trans('file.Status')])}}...">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="text-bold">{{__('Attendance Type')}}</label>
                                                        <select name="attendance_type" id="attendance_type"  class="selectpicker form-control"
...
<script type="text/javascript">
   ...
   $('#other_payment-tab').one('click', function (e) {
    ...
    //     if (login_type=='ip') {
    //         data = '<label class="text-bold">{{__("IP Address")}}</label>';
    //         data += '<input type="text" name="ip_address" id="ip_address" placeholder="Type IP Address"  class="form-control">';
    //         $('#ipField').html(data)
    //     }else{
    //         $('#ipField').empty();
    //     }
