                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="company_id" id="company_id_filter" class="form-control selectpicker dynamic" data-live-search="true" data-live-search-style="contains" data-shift_name="shift_name" data-dependent="department_name" title="{{__('Selecting',['key'=>trans('file.Company')])}}...">
                                        <option value=""></option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="department_id" id="department_id_filter" class="selectpicker form-control designationFilter" data-live-search="true" data-live-search-style="contains" data-designation_name="designation_name" title="{{__('Selecting',['key'=>trans('file.Department')])}}...">
                                    </select>
                                </div>
                            </div>
                            <!--/ Department-->
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select name="designation_id" id="designation_id_filter" class="selectpicker form-control" data-live-search="true" data-live-search-style="contains" title="{{__('Selecting',['key'=>trans('file.Designation')])}}...">
                                </select>
                            </div>
                            <!--/ Designation -->
                            ...
                            <div class="col-md-2 form-group">
                                <label class="text-bold"><b>{{__('Employee Status')}}</b></label>
                                <select name="employee_status" id="employee_status_filter" class="selectpicker form-control" data-live-search-style="contains" title="{{__('Select Employee Status')}}...">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="text-bold">{{__('NIC No')}} <span class="text-danger">*</span></label>
                                <input type="text" name="nic_no" id="nic_no" placeholder="{{__('NIC No')}}"
                                       required class="form-control">
                            </div>
                            <div class="col-md-6 form-group">
                                <label class="text-bold">{{__('Card No')}} <span class="text-danger">*</span></label>
                                <input type="text" name="card_no" id="card_no" placeholder="{{__('Card No')}}"
                                       required class="form-control">
                            </div>
        ...
        var table_table = $('#employee-table').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.employee_status = $('#employee_status_filter').val();
                }
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    exportOptions: {
                        ...
                        format: {
                            body: function ( data, row, column, node ) {
                                if (column === 0) {
                                    var id = data.match(/href="employees\/([^"]*)/)[1];
                    ...
                    customize: function (csv) {
                        ...
                        csvRows[0] = csvRows[0].replace(['"Employee"', '"Company"'], ['"Id"','"Name"']);
                        return csvRows.join('\n');
                    }
                },
                {
