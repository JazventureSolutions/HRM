    ...
    <section>
        ...
        <div class="card animated fadeInRight mr-5 ml-5">
            ...
            <div class="card-body">
                ...
                <p class="card-text">The correct column order is (Full Name, Nic No, Card No, Username, Email, Password,Date of Joining, Gender, Date of Birth, Contact Number, Address, City, Zip, County, Company, Department, Designation, Shift Name, Role Name). Remember, the date format should be (according to general settings) and the company, department, designation, shift and role name must be matched with your existing data. You must follow the csv file, otherwise you will get an error while importing the csv file.</p>
