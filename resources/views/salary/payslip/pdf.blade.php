...
<div class="row">
    <div class="col-xs-12 table-responsive">
        <table class="table table-bordered text-center">
            ...
            <tr>
                <td class="py-3">Special Allownce</td>
                <td>{{$special_allowance}}</td>
            </tr>
            @php
                $total_earnings = $total_earnings + $special_allowance;
            @endphp
            @if($allowances)
...
<div class="row">
    <div class="col-xs-12 table-responsive">
        <table class="table table-bordered text-center">
            ...
            <tr>
                <td class="py-3">Advance Deduct</td>
                <td>{{$advance_deduct}}</td>
            </tr>
            @php
                $total_deductions = $total_deductions + $advance_deduct;
            @endphp
            <tr>
                <td class="py-3">Punishment</td>
                <td>{{$punishment}}</td>
            </tr>
            @php
                $total_deductions = $total_deductions + $punishment;
            @endphp
