                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table no-footer mt-0">
                                                ...
                                                @if($payslip->payment_type == 'Hourly')
                                                    ...
                                                    <tr>
                                                        <td><strong>Overtime:</strong> <span
                                                                    class="pull-right">{{$overtime_amount ?? 0}}</span>
                                                        </td>
                                                    </tr>
                                                @else
                                                    <td><strong>{{__('Basic Salary')}}:</strong> <span
                                            ...
                                            <tr>
                                                <td><strong>Advance Deduct:</strong> <span
                                                            class="pull-right">{{$payslip->advance_deduct ?? 0.00}}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Special Allowance:</strong> <span
                                                            class="pull-right">{{$payslip->special_allowance ?? 0.00}}</span>
                                                </td>
                                            </tr>
                                            ...
                                            @endisset
                                            <tr>
                                                <td><strong>Punishment:</strong> <span
                                                            class="pull-right">{{$payslip->punishment ?? 0.00}}</span>
                                                </td>
                                            </tr>
