                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3 mb-2">
                                ...
                                <div class="input-group">
                                    <input class="form-control month_year date" placeholder="{{__('Select Date')}}" readonly="" id="day_month_year" name="day_month_year" type="text" value="{{now()->format(config('app.date_format'))}}">
